...
class SeatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seating" do
    assert_difference('Seating.count') do
      post seatings_url, params: { seating: { room_id: @seating.room_id, slot: @seating.slot } }
    end
  ...
  test "should update seating" do
    patch seating_url(@seating), params: { seating: { room_id: @seating.room_id, slot: @seating.slot } }
